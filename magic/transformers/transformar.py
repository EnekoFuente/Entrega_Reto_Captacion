...
def transform(data, *args, **kwargs):
    ...
    if 'nombre_producto' in data.columns:
...
def test_output(output, *args) -> None:
    ...
    assert output['nombre_producto'].str.islower().all(), "No todos los nombres de productos están en minúsculas"

    # Asegurarse de que el descuento se aplicó correctamente
    assert (output['precio'] == output['precio'] / 0.9).all(), "El descuento no se aplicó correctamente"
